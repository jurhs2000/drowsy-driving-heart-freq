...
# ask for the participant to use
print('Selecciona el participante a procesar:')
for i in range(len(participants_data)):
    print(f'{i + 1}: {participants_data[i]["participant"]}')
participant = int(input('Participant: '))
person_data = participants_data[participant - 1]
